...
import { useProfesores, ProfesoresProvider } from "./TeachersContext"
...
const ListProfesores = () => {
    ...
    const { profesores, fetchProfesores } = useProfesores();

    useEffect(() => {
        // Asegúrate de que se ejecute solo en el cliente
        if (typeof window !== 'undefined') {
            fetchProfesores(); // Obtiene los profesores al cargar la página
        }
    }, [fetchProfesores])
