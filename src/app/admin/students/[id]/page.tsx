...
// Importando el formulario de modificacion de estudiante
import { UpdateStudentForm } from "@/components/students/update-form"
                ...
                <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
                    ...
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbPage>Modificar Estudiante</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
