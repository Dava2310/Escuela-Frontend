...
const formSchema = z.object({
    ...
    profesion: z
        ...
        .max(255, { message: "La profesión no puede tener más de 255 caracteres." }),
});
...
export default function Page() {
    ...
    useEffect(() => {
        ...
        axios.get(`${ip}/api/users/current`, config)
            .then((response) => {
                const { nombre, apellido, email, cedula, numeroTelefono, direccion, preguntaSeguridad, respuestaSeguridad, profesion } = response.data.body.data;
                ...
                form.setValue('profesion', profesion || '');
            })
            .catch((error) => {
                console.error(error);
            });
